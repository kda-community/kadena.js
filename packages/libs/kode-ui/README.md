...
**@kda-community/kode-ui** is a library used to provide a styling environment and basic
...
```sh
pnpm install @kda-community/kode-ui
```
...
```sh
pnpm install --filter @kda-community/kode-ui
pnpm build --filter @kda-community/kode-ui
```

Add **@kda-community/kode-ui** as a dependency in your `package.json`:

```json
{
  ...
  "dependencies": {
    "@kda-community/kode-ui": "workspace:*",
    ...
  }
}
```
...
**@kda-community/kode-ui** to transpilePackages:
...
from **@kda-community/kode-ui** and components within your application.

### Usage

As mentioned earlier, **@kda-community/kode-ui** provides components and styling
...
them via `@kda-community/kode-ui/styles`:
...
`import '@kda-community/kode-ui/global'` to your app's entry point.
...
can export `darkThemeClass` from **@kda-community/kode-ui** and use it with your theme
provider.
...
generate a set of custom utility classes (similar to Tailwind). @kda-community/kode-ui
