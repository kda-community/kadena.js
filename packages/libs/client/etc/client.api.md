## API Report File for "@kda-community/client"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { ChainId } from '@kda-community/types';
import type Client from '@walletconnect/sign-client';
import { ClientRequestInit } from '@kda-community/chainweb-node-client';
import { ICap } from '@kda-community/types';
import { ICommand } from '@kda-community/types';
import { ICommandResult } from '@kda-community/chainweb-node-client';
import type { IExecPayload } from '@kda-community/types';
import { IKeyPair } from '@kda-community/types';
import type { ILocalCommandResult } from '@kda-community/chainweb-node-client';
import type { ILocalOptions } from '@kda-community/chainweb-node-client';
import { IPollResponse } from '@kda-community/chainweb-node-client';
import { IPreflightResult } from '@kda-community/chainweb-node-client';
import type { ISigningCap } from '@kda-community/types';
import { IUnsignedCommand } from '@kda-community/types';
import type { LocalRequestBody } from '@kda-community/chainweb-node-client';
import type { LocalResponse } from '@kda-community/chainweb-node-client';
